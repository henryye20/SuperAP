...
public class BBoard {		// This is your main file that connects all classes.
	...
	public void login(){
		...
		String pwd;
		while(exit) {
			System.out.println("Enter your username please('Q' or 'q' to exit");
			user = sc.nextLine();
			...
			System.out.println("Enter your password please('Q' or 'q') to exit: ");
			pwd = sc.nextLine();
	...
	public void run(){
		...
		while(exit) {
			...
			String ans = toLowerCase(sc.nextLine());
			if(ans.equals("d")) {
				display();
			}
			if(ans.equals("n")) {
